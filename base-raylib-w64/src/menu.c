...
void exibirMenu(Pista** listaPistas) {
    ...
    while (!iniciarJogo && !WindowShouldClose()) {
        ...
        DrawText("1 - Ver todas as pistas", 100, 100, 20, DARKGRAY);
        DrawText("2 - Filtrar pistas por personagem", 100, 130, 20, DARKGRAY);
        DrawText("3 - Contar pistas por personagem", 100, 160, 20, DARKGRAY);
        DrawText("4 - Começar o jogo", 100, 190, 20, DARKGRAY);
